      ...
      <header>
        <Popover className="relative bg-white">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'items-center bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',
                      )}
                    >
                      <span>Solutions</span>
                      <ChevronDownIcon
          ...
          >
            ...
            >
              <div className="rounded-lgp shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
